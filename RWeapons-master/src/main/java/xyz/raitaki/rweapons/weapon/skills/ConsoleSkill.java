...
public class ConsoleSkill extends Skill {
    ...
    public ConsoleSkill(Weapon weapon, Vector3f vector3f, double v) {
    ...
    public void activate() {
        ...
        viewer.getStraightLines().get(1).text(Component.text("============================BiOS-0.01============================").color(TextColor.color(0,255,255)));
        ...
        new BukkitRunnable(){
            public void run() {
                ...
                if(timer == 5*15){
                    viewer.addText("&7Logining as " + getWeapon().getOwner().getName().getBytes() + ".");
                }
                if(timer == 6*15){
